...
void findMaxElementBelowCounterDiagonal(int **pMatrix, int matrixSize)
{
  ...
  cout << "Max element below counter-diagonal is " << pMatrix[rowIndexOfMaxElement][columnIndexOfMaxElement]
       << " with index (" << rowIndexOfMaxElement << ";" << columnIndexOfMaxElement << ") " << endl;
